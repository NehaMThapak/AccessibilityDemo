...
// ------------------------------------
var scrollEvents=["wheel.preloader-page.wm","mousewheel.preloader-page.wm","touchmove.preloader-page.wm","DOMMouseScroll.preloader-page.wm"];
// left: 37, up: 38, right: 39, down: 40,
// spacebar: 32, pageup: 33, pagedown: 34, end: 35, home: 36
var scrollKeys={32:1,33:1,34:1,35:1,37:1,38:1,39:1,40:1};var $lastFocused;
// Initialize
init();
...
$(window).on("start.preloader-page.wm",onPreloadPageStart).on("complete.preloader-page.wm",onPreloadPageComplete).on(scrollEvents.join(" "),onPreloadPageScroll);$("#preloader-page").on("blur.preloader-page.wm",onPreloadPageBlur);$(document).on("click.preloader-page.wm","#preloader-page.in",onPreloadPageClick).on("keydown.preloader-page.wm",onPreloadPageScrollKeys)}/**
...
if($preloader.hasClass("in")){$preloader.focus()}}/**
	 ...
	 */
function onPreloadPageClick(event){event.stopImmediatePropagation()}/**
	 ...
	 */
function onPreloadPageComplete(event){$("#preloader-page").removeClass("in").attr("aria-hidden","true");$("html,body").removeClass("preloader-page-open");$lastFocused.focus();$lastFocused=null}/**
	 ...
	 */
function onPreloadPageScroll(event){if($("#preloader-page").hasClass("in")){event.preventDefault()}}/**
	 ...
	 * prevent the event default.
	 */
function onPreloadPageScrollKeys(event){if(scrollKeys[event.keyCode]&&$("#preloader-page").hasClass("in")){event.preventDefault()}}/**
	 ...
	 */
function onPreloadPageStart(event){$lastFocused=$(":focus");$("#preloader-page").addClass("in").attr("aria-hidden","false").focus();$("html,body").addClass("preloader-page-open")}})(jQuery);